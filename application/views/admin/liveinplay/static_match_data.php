...
<form action="<?php echo base_url('admin/create_match_option_static_new'); ?>" method="post" accept-charset="utf-8">
    ...
    <?php
      $i=0;$j=1; foreach($new_questions as $val) :
      $v = $this->db->query("SELECT * FROM bet_answers WHERE question_id='{$val->id}'")->row();
      //dd($v);
    ?>
        <fieldset class="label_side top">
            <label for="required_field">Q: <?php echo $j; ?></label>
            <div class="clearfix">
                <input name="questions[]" value="<?php echo $val->question_title; ?>" type="text" class="text">
                <br>
            ...
            <?php if( $val->answer_type == 'TEAM_NAME' ) { ?>
                ...
                <div class="clearfix">
                    <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                        <input type="text" value="<?php echo $first_team; ?>" name="answers_<?=$i;?>[]" class="valid">
                        <input type="text" value="<?php echo $v->rate_1; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                    </div>

                    <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                        <input type="text" value="<?php echo $second_team; ?>" name="answers_<?=$i;?>[]" class="valid">
                        <input type="text" value="<?php echo $v->rate_2; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                    </div>
                </div>
            ...
            <?php } else if( $val->answer_type == 'TEAM_NAME_WITH_DRAW' ) { ?>
                ...
                <div class="clearfix">
                    ...
                    <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                        <input type="text" value="Draw" name="answers_<?=$i;?>[]" class="valid">
                        <input type="text" value="<?php echo $v->rate_2; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                    </div>

                    <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                        <input type="text" value="<?php echo $second_team; ?>" name="answers_<?=$i;?>[]" class="valid">
                        <input type="text" value="<?php echo $v->rate_3; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                    </div>
                </div>
            ...
            <?php } else if( $val->answer_type == 'TEAM_NAME_WITH_TIE' ) { ?>
                ...
                <div class="clearfix">
                    ...
                    <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                        <input type="text" value="Tie" name="answers_<?=$i;?>[]" class="valid">
                        <input type="text" value="<?php echo $v->rate_2; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                    </div>
            ...
            <?php } else if( $val->answer_type == 'TEAM_NAME_WITH_NOGOAL' ) { ?>
                ...
                <div class="clearfix">
                    ...
                    <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                        <input type="text" value="No Goal" name="answers_<?=$i;?>[]" class="valid">
                        <input type="text" value="<?php echo $v->rate_2; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                    </div>
            ...
            ?>
                ...
                <div class="clearfix">
                    <?php foreach( $get_data as $val ) : ?>
                            <div class="col_20" style="margin-top:2px; margin-bottom:3px;">
                                <input type="text" value="<?php echo $val->answer; ?>" name="answers_<?=$i;?>[]" class="valid">
                                <input type="text" value="<?php echo $val->rate_1; ?>" class="col_160" name="ratios_<?=$i;?>[]">
                            </div>
                    <?php endforeach; ?>
                </div>
