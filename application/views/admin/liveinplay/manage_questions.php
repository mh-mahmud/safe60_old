                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    data-end_time_local="<?php echo $val->end_time; ?>"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="<?php echo base_url('admin/edit_match_bet_name'); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="ending_time" class="control-label mb-1">Ends At</label>
                                        <input id="ending_time" type="text" autocomplete="off" name="ending_time" type="text" class="form-control myTimePicker" required>
                                    </div>
...
<script>
    ...
    $('.bet-edit-modal').on('click', function() {
        ...
        var end_time_local = $(this).attr('data-end_time_local');
        ...
        $("#ending_time").val(end_time_local);
