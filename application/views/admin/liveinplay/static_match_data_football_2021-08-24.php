...
<form action="<?php echo base_url('admin/create_match_option_static_new'); ?>" method="post" accept-charset="utf-8">
    ...
    <fieldset class="label_side top">
        ...
        <fieldset class="label_side top">
            ...
            <div class="clearfix">
                <input name="questions[]" value="First Goal..?" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $first_team; ?>" name="answers_2[]" class="valid">
                    <input type="text" value="1.70" class="col_160" name="ratios_2[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No Goal" name="answers_2[]" class="valid">
                    <input type="text" value="3.33" class="col_160" name="ratios_2[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $second_team; ?>" name="answers_2[]" class="valid">
                    <input type="text" value="1.90" class="col_160" name="ratios_2[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->
            ...
            <label for="required_field">Q: 5</label>
            <div class="clearfix">
                <input name="questions[]" value="Total Match Goal" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="1 Goal" name="answers_4[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_4[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="2 Goal" name="answers_4[]" class="valid">
                    <input type="text" value="2.11" class="col_160" name="ratios_4[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="3 Goal" name="answers_4[]" class="valid">
                    <input type="text" value="2.22" class="col_160" name="ratios_4[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="4 Goal" name="answers_4[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_4[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="5 Or +" name="answers_4[]" class="valid">
                    <input type="text" value="4.44" class="col_160" name="ratios_4[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No Goal" name="answers_4[]" class="valid">
                    <input type="text" value="4.44" class="col_160" name="ratios_4[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->
            ...
            <label for="required_field">Q: 6</label>
            <div class="clearfix">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Odd" name="answers_5[]" class="valid">
                    <input type="text" value="1.91" class="col_160" name="ratios_5[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Even" name="answers_5[]" class="valid">
                    <input type="text" value="1.91" class="col_160" name="ratios_5[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No Goal" name="answers_5[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_5[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 7</label>
            <div class="clearfix">
                <input name="questions[]" value="Goal in Half Time" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Yes" name="answers_6[]" class="valid">
                    <input type="text" value="1.31" class="col_160" name="ratios_6[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No" name="answers_6[]" class="valid">
                    <input type="text" value="2.33" class="col_160" name="ratios_6[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 8</label>
            <div class="clearfix">
                <input name="questions[]" value="Red Card in the Match?" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Yes" name="answers_7[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_7[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No" name="answers_7[]" class="valid">
                    <input type="text" value="1.11" class="col_160" name="ratios_7[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 9</label>
            <div class="clearfix">
                <input name="questions[]" value="Double Chance to Win" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Draw" name="answers_8[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_8[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $first_team; ?> Or <?php echo $second_team; ?>" name="answers_8[]" class="valid">
                    <input type="text" value="1.17" class="col_160" name="ratios_8[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 10</label>
            <div class="clearfix">
                <input name="questions[]" value="Goal in Half Time [Under/Over]" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Under 1.5 [1]" name="answers_9[]" class="valid">
                    <input type="text" value="1.81" class="col_160" name="ratios_9[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Over 1.5 [2 & +]" name="answers_9[]" class="valid">
                    <input type="text" value="1.81" class="col_160" name="ratios_9[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No Goal" name="answers_9[]" class="valid">
                    <input type="text" value="2.22" class="col_160" name="ratios_9[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 11</label>
            <div class="clearfix">
                <input name="questions[]" value="Win 2nd Half Time" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $first_team; ?>" name="answers_10[]" class="valid">
                    <input type="text" value="1.81" class="col_160" name="ratios_10[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Draw" name="answers_10[]" class="valid">
                    <input type="text" value="1.81" class="col_160" name="ratios_10[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $first_team; ?>" name="answers_10[]" class="valid">
                    <input type="text" value="2.11" class="col_160" name="ratios_10[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->


            <label for="required_field">Q: 12</label>
            <div class="clearfix">
                <input name="questions[]" value="Goal in 2nd Half [Under/Over]" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Under 1.5 [1]" name="answers_11[]" class="valid">
                    <input type="text" value="1.81" class="col_160" name="ratios_11[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Over 1.5 [2 & +]" name="answers_11[]" class="valid">
                    <input type="text" value="1.81" class="col_160" name="ratios_11[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No Goal" name="answers_11[]" class="valid">
                    <input type="text" value="2.22" class="col_160" name="ratios_11[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 13</label>
            <div class="clearfix">
                <input name="questions[]" value="Penalty in the Match?" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Yes" name="answers_12[]" class="valid">
                    <input type="text" value="2.22" class="col_160" name="ratios_12[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No" name="answers_12[]" class="valid">
                    <input type="text" value="1.21" class="col_160" name="ratios_12[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->

            <label for="required_field">Q: 14</label>
            <div class="clearfix">
                <input name="questions[]" value="Last Team to Score" type="text" class="text">
                <br>
                <input name="min[]" value="<?php echo $match_data->min_bet_limit; ?>" placeholder="min bet limit" type="text" class="text">
                <br>
                <input name="max[]" value="<?php echo $match_data->max_bet_limit; ?>" placeholder="max bet limit" type="text" class="text">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $first_team; ?>" name="answers_13[]" class="valid">
                    <input type="text" value="2.11" class="col_160" name="ratios_13[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="<?php echo $second_team; ?>" name="answers_13[]" class="valid">
                    <input type="text" value="2.11" class="col_160" name="ratios_13[]">
                </div>
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="No Goal" name="answers_13[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_13[]">
                </div>
            </div>
            <!-------------------------------- ######################## -------------------------------------------->
