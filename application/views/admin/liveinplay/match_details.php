                        ...
                        <div class="row">
                            ...
                            <form action="<?php echo base_url('admin/post_create_match'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sports_name" class="form-control sports_name" required>
                                    <option value="">--- select ---</option>
                                ...
                                <div class="form-group">
                                    <label for="league_title" class="control-label mb-1">League Name</label>
                                    <select name="league_title" class="form-control league_title">
                                    <option value="">--- select ---</option>
                    ...
                    <div class="modal-body" style="padding:20px !important;">
                        <div class="row">
                            ...
                            <form action="<?php echo base_url('admin/post_edit_match'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <label for="sports_name" class="control-label mb-1">Sports</label>
                                    <select id="edit_sports_name" name="sports_name" class="form-control sports_name" required>
                                    <option value="">--- select ---</option>
                                        <?php foreach($sports as $val) : ?>
                                            <option value="<?php echo $val->id; ?>"><?php echo $val->name; ?></option>
                                        <?php endforeach; ?>
                                ...
                                <div class="form-group">
                                    <label for="league_title" class="control-label mb-1">League Name</label>
                                    <select id="league_title" name="league_title" class="form-control league_title">
                                    <option value="">--- select ---</option>
                                        <?php foreach($leagues as $val) : ?>
                                            <option value="<?php echo $val->id; ?>"><?php echo $val->league_name; ?></option>
                                        <?php endforeach; ?>
...
<script>
    ...
    $(".sports_name").on("change", function() {
        ...
        if(sports_id!="") {
            ...
            $.ajax({
                type: "POST",
                url: url_prefix + 'admin/get_league_name',
                data: {
                    sports_id: sports_id
                },
                dataType: 'html',
                success: function(data) {
                    $(".league_title").html(data);
                },
                error:function(exception){
                    console.log(exception);
                }
