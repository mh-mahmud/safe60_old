                                        ...
                                        <div class="panel panel-default set-win-<?= $data->id; ?>" style="margin:5px;font-size:12px">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class=" row option-data col-md-3 col-sm-3 col-xs-6" style="margin-bottom:10px;text-align:center;margin-left:10px">
														...
														<button id="button_<?= $id; ?>" onclick="return hideBetOption(<?= $id ?>)" class="btn btn-xs <?php echo ($op->status==1) ? 'btn-primary' : 'btn-danger'; ?>"><?php echo ($op->status==1) ? 'Hide' : 'Show'; ?></button>
...
<script>
	...
	// hide shw option function
    function hideBetOption(id) {
        ...
        $.ajax({
            type: "POST",
            url: url_prefix + 'admin/hide_show_bet_option',
            data: {
                option_details_id: id
            },
            dataType: 'json',
            success: function(data) {
                console.log(data);
                $("#button_"+id).html(data.hide_type).removeClass(data.remove_class).addClass(data.add_class);
            },
            error:function(exception){
                console.log(exception);
            }
