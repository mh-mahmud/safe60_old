...
<form action="<?php echo base_url('admin/create_match_option_static_new'); ?>" method="post" accept-charset="utf-8">
    ...
    <fieldset class="label_side top">
        ...
        <fieldset class="label_side top">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Over 2.5" name="answers_2[]" class="valid">
                    <input type="text" value="1.60" class="col_160" name="ratios_2[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="Under 2.5" name="answers_2[]" class="valid">
            ...
            <div class="clearfix">
                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="1 Goal" name="answers_3[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_3[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="2 Goal" name="answers_3[]" class="valid">
                    <input type="text" value="2.11" class="col_160" name="ratios_3[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="3 Goal" name="answers_3[]" class="valid">
                    <input type="text" value="2.22" class="col_160" name="ratios_3[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="4 Goal" name="answers_3[]" class="valid">
                    <input type="text" value="3.11" class="col_160" name="ratios_3[]">
                </div>

                <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                    <input type="text" value="5 Or +" name="answers_3[]" class="valid">
                    <input type="text" value="4.44" class="col_160" name="ratios_3[]">
                </div>
