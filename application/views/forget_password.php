    ...
    <div id="loginRegister" class="row mr-auto justify-content-center">
        ...
        <nav class="navbar navbar-expand-md navbar-light col-xl-10 pr-0">
            ...
            <a class="navbar-brand hm-HeaderModule_Logo" href="<?= base_url(); ?>">
                ...
                <img style="height:36px !important" id="header-logo" src="<?= base_url(); ?>assets/images/3xbet.png" alt="Logo" class="responsive">
            </a>
        ...
        <div id="userProfile">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 card pl-0 pr-0 rounded-0 clearfix">
                ...
                <div class="container">
                    ...
                    <form action="" class="form-signin" style="margin-top:100px" method="POST">
                      
                      <h4 style="margin-bottom:20px;">Forget Password</h3>
                      ...
                      <input type="password" id="inputPassword" name="old_password" class="form-control" placeholder="Old Password" required>
                      <label for="inputPassword" class="sr-only">New Password</label>
                      <input type="password" id="inputPassword2" min="6" name="new_password" class="form-control" placeholder="New Password" required>
                      <br>
